...
from sqlalchemy import (
    ...
    Numeric, String, Text, DateTime, JSON, Index
)
...
class LearningPath(BaseModel):
    ...
    # 适用条件
    prerequisite_nodes = Column(
        JSON,
        nullable=True,
        comment="前置知识节点"
    )
    
    target_grade_levels = Column(
        JSON,
        nullable=True,
        comment="适用年级"
    )
