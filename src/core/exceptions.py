...
class BailianQuotaExceededError(BailianServiceError):
    ...
    def __init__(self, message: str = "百炼API调用配额已用完"):
        super().__init__(
            message=message,
            error_code="BAILIAN_QUOTA_EXCEEDED_ERROR"
        )
...
class HomeworkCorrectionError(HomeworkError):
    ...
    def __init__(self, message: str = "作业批改失败", homework_id: Optional[str] = None):
        super().__init__(
            message=message,
...
class OCRProcessError(HomeworkError):
    ...
    def __init__(self, message: str = "图像文字识别失败", image_path: Optional[str] = None):
        super().__init__(
            message=message,
...
class ContextLoadError(LearningQAError):
    ...
    def __init__(self, message: str = "学习上下文加载失败", user_id: Optional[str] = None):
        super().__init__(
            message=message,
...
class RecordNotFoundError(DatabaseError):
    ...
    def __init__(self, message: str = "记录未找到", resource: str = "", resource_id: str = ""):
        super().__init__(
            message=message,
...
class RecordAlreadyExistsError(DatabaseError):
    ...
    def __init__(self, message: str = "记录已存在", resource: str = "", unique_field: str = ""):
        super().__init__(
            message=message,
...
class UserPermissionError(UserError):
    ...
    def __init__(self, message: str = "用户权限不足", required_permission: Optional[str] = None):
        super().__init__(
            message=message,
...
class ValidationError(APIError):
    ...
    def __init__(self, message: str = "数据验证失败", field_errors: Optional[Dict] = None):
        super().__init__(
            message=message,
...
class RateLimitError(APIError):
    ...
    def __init__(self, message: str = "API调用频率过高", limit: int = 100, window: int = 3600):
        super().__init__(
            message=message,
