...
from src.core.exceptions import (
    AuthenticationError, ValidationError, ConflictError, ServiceError
)
from src.schemas.auth import (
    RegisterRequest, LoginRequest, LoginResponse,
    RefreshTokenRequest, RefreshTokenResponse,
    LogoutRequest, SendVerificationCodeRequest,
...
@router.post("/send-verification-code", response_model=VerifyCodeResponse, summary="发送验证码")
...
async def reset_password(
    ...
    try:
        ...
        return SuccessResponse(
            message="密码重置成功" if success else "密码重置失败"
        )
